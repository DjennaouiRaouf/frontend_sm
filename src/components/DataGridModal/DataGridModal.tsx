...
import {Variants} from "../../Redux-Toolkit/Slices/AlertSlice";
import {show as showAlert} from '../../../src/Redux-Toolkit/Slices/AlertSlice'
import {hide} from "../../Redux-Toolkit/Slices/DataGridModalSlice";
...
const DataGridModal: React.FC<DataGridModalProps> = (props) => {
    const [validated, setValidated] = useState(false);
    const [fields,setFields]=useState<any[]>([]);
    const [defaultState,setDefaultState]=useState<any>({});
    const [formData, setFormData] = useState<any>({});
    const dispatch = useDispatch();
    const { show } = useSelector((state: RootState) => state.dataGridModal);
